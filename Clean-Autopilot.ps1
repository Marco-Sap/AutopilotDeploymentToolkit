...
.EXAMPLE
Start Autopilot device and Intune cleanup and re-check if the devices are deleted. Report not deleted devices serial numbers.
...
$CsvFile = "D:\SerieNummers.csv"
Start-AutopilotCleanupCSV -CsvFile $CsvFile

#200 is correct delete
#400 is not deleted